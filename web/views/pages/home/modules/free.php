<div class="container-fluid bg-light border">
    <div class="container clearfix">
        <div class="btn-group float-end p-2">
                <button class="btn btn-default btnView bg-gray" attr-type="grid" attr-index="1">
...
<div class="container-fluid bg-white">
    <div class="container">
        <div class="clearfix pt-3 pb-0 px-2">
            <h6 class="float-start text-uppercase pt-2">Artículos Gratuitos</h6>
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4 pt-3 pb-4 grid-1">
            <div class="col px-3 py-2 py-lg-0">
                <a href="#">
                    ...
                    <h6>
                        <small class="text-uppercase text-muted">Collar de Diamantes</small>
                    </h6>
                </a>
                <h6>
            ...
            <div class="col px-3 py-2 py-lg-0">
                <a href="#">
                    ...
                    <h6>
                        <small class="text-uppercase text-muted">Maletín</small>
                    </h6>
                </a>
                <h6>
                    <span class="badge badgeNew bg-warning text-uppercase text-white mt-1 p-2">Nuevo</span>
            ...
            <div class="col px-3 py-2 py-lg-0">
                <a href="#">
                    ...
                    <h6>
                        <small class="text-uppercase text-muted">Morral</small>
                    </h6>
                </a>
                <h6>
                    <span class="badge badgeNew bg-warning text-uppercase text-white mt-1 p-2">Nuevo</span>
            ...
            <div class="col px-3 py-2 py-lg-0">
                <a href="#">
                    ...
                    <h6>
                        <small class="text-uppercase text-muted">Pulsera de Diamantes</small>
                    </h6>
                </a>
                <h6>
                    <span class="badge badgeNew bg-warning text-uppercase text-white mt-1 p-2">Nuevo</span>
        ...
        <div class="row list-1" style="display: none;">
            ...
            <div class="media border-bottom px-3 pt-4 pb-3 pb-lg-2">
                ...
                <div class="media-body ps-3">
                    <h6>
                        <small class="text-uppercase text-muted">Maletin</small>
                    </h6>
                    <h6>
                        <span class="badge badgeNew bg-warning text-uppercase text-white p-2">Nuevo</span>
                    </h6>
