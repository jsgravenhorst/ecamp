<div class="container-fluid bg-light border">
    <div class="container clearfix">
        <div class="btn-group float-end p-2">
                <button class="btn btn-default btnView bg-gray" attr-type="grid" attr-index="3">
...
<div class="container-fluid bg-white">
    <div class="container">
        <div class="clearfix pt-3 pb-0 px-2">
            <h6 class="float-start text-uppercase pt-2">Artículos más vendidos</h6>
        ...
        <div class="col px-3 py-2 py-lg-0">
            ...
            <div class="clearfix">
                <h6 class="float-start text-uppercase text-muted pt-2">
                    <del class="small" style="color: #bbb;">USD $29</del> 
                    $11
                </h6>
                <span class="float-end">
                    <div class="btn-group btn-group-sm">
